...
\declaretheorem[style=thmsty,numberwithin=chapter,name=Algoritmo]{algoritmo}

\declaretheorem[style=thmsty,numberwithin=chapter,name=Definição]{definicao}
\declaretheorem[style=thmsty,numberwithin=chapter,name=Premissa]{premissa}

\declaretheorem[style=thmsty,numberwithin=chapter,name=Afirmação]{afirmacao}
\declaretheorem[style=thmsty,numberwithin=chapter,name=Observação]{observacao}
\declaretheorem[style=thmsty,numberwithin=chapter,name=Corolário]{corolario}
\declaretheorem[style=thmsty,numberwithin=chapter,name=Lema]{lema}
\declaretheorem[style=thmsty,numberwithin=chapter,name=Teorema]{teorema}
